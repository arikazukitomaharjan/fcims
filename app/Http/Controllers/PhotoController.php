...
class PhotoController extends Controller
{
    ...
    public function store(CreatePhotoRequest $request, Photo $photo)
    {
        ...
        $request->file('image')->move(
            base_path() . '/public/img/uploads/images', $imageName
        );

       Image::make(base_path() .'/public/img/uploads/images/' . $imageName, array(
            'width' => 120,
            'height' => 190,
        ))->save(base_path() .'/public/img/uploads/thumbnails/photos/'.$imageName);
    ...
    public function getPhotosByAlbum(Photo $photo, $albumID)
    {
     ...
     public function getPhotosByAlbumCollection(Photo $photo, $albumID)
    {
        $photos = $photo->getPhotosByAlbumCollection($photo, $albumID, 18);
        $photos->setPath($albumID);
